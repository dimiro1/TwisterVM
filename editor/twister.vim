...
syn keyword twisterOpcodes lt_s gt_s lte_s gte_s eq_s lt_n gt_n lte_n gte_n eq_n not_lt_s zero_n not_zero_n
syn keyword twisterOpcodes not_gt_s not_lte_s not_gte_s not_eq_s not_lt_n not_gt_n not_lte_n not_gte_n not_eq_n
